...
<feed xmlns="http://www.w3.org/2005/Atom">
    <title type="text">Paddy's post</title>
...
`setLink()` | Set a URI to the HTML website containing the same or similar information as this feed (i.e. if the feed is from a post, it should provide the post's URI where the HTML version of the entries can be read).
...
`setLink()` | Set a URI to the HTML website containing the same or similar information as this entry (i.e. if the feed is from a post, it should provide the post article's URI where the HTML version of the entry can be read).
