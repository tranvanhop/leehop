var Layout = function () {
    ...
    var handleTheme = function () {
        ...
        var setColor = function (color) {
            $('#style-color').attr("href", url_base + "/theme/assets/frontend/onepage/css/themes/" + color + ".css");
            $('.site-logo img').attr("src", url_base + "/theme/assets/frontend/onepage/img/logo/" + color + ".png");
        }
